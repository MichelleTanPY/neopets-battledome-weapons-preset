...
document.getElementById("equipment").addEventListener("click", () => {
  ...
  let ability, equipment1, equipment2, fight, skipReplay, collectRewards;
  ...
  if (activePreset.id === "preset1") {
    ...
    fight = document.getElementById("fight").checked;
    ...
    fight = document.getElementById("fight2").checked;
...
document.addEventListener("DOMContentLoaded", () => {
  chrome.storage.sync.get(
    ...
    (data) => {
      ...
      document.getElementById("fight").checked = data.fight || false;
      document.getElementById("skipReplay1").checked =
        data.skipReplay1 || false;
      document.getElementById("collectRewards1").checked =
      ...
      document.getElementById("fight2").checked = data.fight2 || false;
      document.getElementById("skipReplay2").checked =
        data.skipReplay2 || false;
      document.getElementById("collectRewards2").checked =
...
function disableInputs() {
  document
    .querySelectorAll("#preset1 input, #preset2 input")
    .forEach((input) => {
      input.disabled = true;
    });
